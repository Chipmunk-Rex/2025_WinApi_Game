...
{
    cards = {
        { L"달", L"아무 능력 없는 달이 추가됩니다.", L"Projectile_Moon", new DefaultBallCard(), 3,CardType::Skill},
        { L"토성", L"고리로 광역 공격을 하는 토성을 추가합니다.", L"Projectile_Saturn", new LaserBallCard(), 3, CardType::StrongSkill},
        { L"지구", L"피격 시 적이 느려지는 특징이 있는 지구를 획득합니다.", L"Projectile_Earth", new SlowBallCard(), 3,  CardType::Skill},
        { L"블랙홀", L"블랙홀로 붕괴하는 \n불안정한 적색거성을 \n 얻습니다.", L"Projectile_Blackhole", new BlackholeCard(), 3, CardType::StrongSkill},
