...
{
    { L"토성 추가", L"고리로 광역 공격을 하는 \n토성을 추가합니다.", L"Projectile_Saturn", s_laserBallCard, 3, CardType::StrongSkill},
    { L"지구 추가", L"피격 시 적이 느려지는 특징이 있는 지구를 추가합니다.", L"Projectile_Earth", s_slowBallCard, 3,  CardType::Skill},
    { L"달 추가", L"아무 능력 없는 \n달이 추가됩니다.", L"Projectile_Moon", s_defaultBallCard, 3,CardType::Skill},
